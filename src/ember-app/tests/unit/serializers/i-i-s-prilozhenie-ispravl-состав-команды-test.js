...
moduleForModel('i-i-s-prilozhenie-ispravl-состав-команды', 'Unit | Serializer | i-i-s-prilozhenie-ispravl-состав-команды', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-ispravl-состав-команды',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
