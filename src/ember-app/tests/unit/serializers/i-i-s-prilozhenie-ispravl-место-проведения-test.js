...
moduleForModel('i-i-s-prilozhenie-ispravl-место-проведения', 'Unit | Serializer | i-i-s-prilozhenie-ispravl-место-проведения', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-ispravl-место-проведения',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
