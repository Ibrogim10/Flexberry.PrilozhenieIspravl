...
moduleForModel('i-i-s-prilozhenie-ispravl-т-ч-состав-спорт', 'Unit | Serializer | i-i-s-prilozhenie-ispravl-т-ч-состав-спорт', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-ispravl-т-ч-состав-спорт',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
