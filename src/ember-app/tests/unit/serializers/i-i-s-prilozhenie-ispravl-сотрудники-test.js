...
moduleForModel('i-i-s-prilozhenie-ispravl-сотрудники', 'Unit | Serializer | i-i-s-prilozhenie-ispravl-сотрудники', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-ispravl-сотрудники',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
