...
moduleForModel('i-i-s-prilozhenie-ispravl-т-ч-графика', 'Unit | Serializer | i-i-s-prilozhenie-ispravl-т-ч-графика', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-ispravl-т-ч-графика',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
