...
moduleForModel('i-i-s-prilozhenie-ispravl-группы-возраст', 'Unit | Serializer | i-i-s-prilozhenie-ispravl-группы-возраст', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-ispravl-группы-возраст',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
