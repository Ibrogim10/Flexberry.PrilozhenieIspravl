...
moduleForModel('i-i-s-prilozhenie-ispravl-график-матчей', 'Unit | Serializer | i-i-s-prilozhenie-ispravl-график-матчей', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-ispravl-график-матчей',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
