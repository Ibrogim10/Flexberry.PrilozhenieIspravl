...
moduleForModel('i-i-s-prilozhenie-ispravl-спортсмены', 'Unit | Serializer | i-i-s-prilozhenie-ispravl-спортсмены', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-ispravl-спортсмены',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
