...
moduleForAcceptance('[AGAT] Acceptance | i i s prilozhenie ispravl место проведения l');

test('testing i-i-s-prilozhenie-ispravl-место-проведения-l', function(assert) {
